...
class auth_plugin_enrolkey extends auth_plugin_base {
    ...
    public function __construct() {
        ...
        $this->config = get_config('auth_mini');
    }
    ...
    public function loginpage_hook() {
        ...
        if ($CFG->registerauth == $this->authtype and empty($CFG->auth_instructions)) {
            ...
            $CFG->auth_instructions = get_string('signup_auth_instructions', 'auth_mini', $url);
        }
    ...
    public function signup_form() {
        return new \auth_mini\form\enrolkey_signup_form(null, null, 'post', '', array('autocomplete' => 'on'));
    }
    ...
    private function email_confirmation() {
        ...
        if ($USER->confirmed !== '1' && get_config('auth_mini', 'emailconfirmation')) {
            require_logout();
